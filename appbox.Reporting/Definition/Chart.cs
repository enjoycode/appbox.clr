            ...
            foreach (XmlNode xNodeLoop in xNode.ChildNodes)
            {
                ...
                switch (xNodeLoop.Name)
                {
                    ...
                    case "ChartElementOutput":
                        _ChartElementOutput = RDL.ChartElementOutput.GetStyle(xNodeLoop.InnerText, OwnerReport.rl);
                        break;
        ...
        override internal void RunPage(Pages pgs, Row row)
        {
            ...
            try
            {
                ...
                if (!_isHYNEsWonderfulVector.EvaluateBoolean(rpt, row)) //AJM GJL 14082008 'Classic' Rendering 
                {
                    ...
                    //appbox.Drawing.Image im = cb.Image(rpt);	// Grab the image
                ...
                {
                    throw new NotImplementedException();
                    //appbox.Drawing.Imaging.Metafile im = cb.Image(rpt);	// Grab the image
