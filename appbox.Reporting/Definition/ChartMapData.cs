...
namespace appbox.Reporting.RDL
{
    internal class MapData
    {
        ...
        private void ReadXmlText(XmlReader xr)
        {
            ...
            string family = Style.DefaultFontFamily;
            float fontsize = 8;
            bool bBold = false;
            bool bItalic = false;
    ...
    internal class MapLines : MapObject
    {
        ...
        internal override void Draw(Graphics g, float scale, float offX, float offY)
        {
            ...
            g.DrawPolygon(Drawing.Color.Black, 1, drawpoly);
        }
    }
    ...
    internal class MapPolygon : MapObject
    {
        ...
        internal override void Draw(Graphics g, float scale, float offX, float offY)
        {
            ...
            g.DrawPolygon(Color.Black, 1, drawpoly);
            if (!Fill.IsEmpty)
            {
    ...
    internal class MapText : MapObject
    {
        ...
        public string FontFamily = Style.DefaultFontFamily;
        ...
        internal Font GetFont(float scale)
        {
            ...
            {
                font = new Font(Style.DefaultFontFamily, size, fs);
            }
            return font;
        }
        ...
        internal override void Draw(Graphics g, float scale, float offX, float offY)
        {
            Font f = GetFont(scale);
            g.DrawString(Text, f, Color.Black, offX + Location.X * scale, offY + Location.Y * scale);
            f.Dispose();
        }
    }
}
