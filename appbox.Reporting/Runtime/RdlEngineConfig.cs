      ...
      <CustomReportItem>
        ...
        static void GetDataSource(IDictionary dsDir, XmlNode xNode)
        {
            ...
            {   // load the module early; saves problems with concurrency later 
                ...
                if (codemodule != null && cname != null)
                {
                    ...
                    //   many of the DataProvider done by Reporting are in a single code module 
        ...
        public static IDbConnection GetConnection(string provider, string cstring)
        {
            ...
            switch (provider.ToLower())
            {
                ...
                //    break;
                //case "filedirectory":
                //    cn = new Data.FileDirConnection(cstring);
                //    break;
                //case "xml":
                //    cn = new Data.XmlConnection(cstring);
                //    break;
                //case "webservice":
                //    cn = new Data.WebServiceConnection(cstring);
                //    break;
                //case "weblog":
                //    cn = new Data.LogConnection(cstring);
                //    break;
                //case "text":
                //    cn = new Data.TxtConnection(cstring);
                //    break;
                //case "itunes":
                //    cn = new Data.iTunesConnection(cstring);
                //    break;
                ...
                default:
                    ...
                    Console.WriteLine("Provider Create Instance");
