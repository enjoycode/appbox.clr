...
//        public void AddImage(appbox.Reporting.RDL.Image image, int pictureIndex)
//        {
...
//        public void AddLine(appbox.Reporting.RDL.Line line, float borderWidth)
//        {
...
//            var tableTop = /*table.Top == null ? 0f :*/ table.Top.Points;
//            var tableLeft = /*table.Left == null ? 0f :*/ table.Left.Points;
...
//                    break;
//                }
//                if ((rl is DataRegion || rl is appbox.Reporting.RDL.Rectangle) && !(rl is CustomReportItem))
//                {
