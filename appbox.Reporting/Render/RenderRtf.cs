...
namespace appbox.Reporting.RDL
{
    ...
    internal class RenderRtf : IPresent
    {
        ...
        List<string> _Fonts;        // list of fonts used
        List<Color> _Colors;         // list of colors used
...
\brdroutset Outset border.
        ...
        {
            using (var im = Drawing.Image.FromStream(ioin))
            {
		...
		void PutImage(appbox.Drawing.Image im, int width, int height)
        {
